...
class MainScreen:
    ...
    def initLabels(self) -> [Label]:
        labels = []
        labels.append(Label(Settings.MAIN_FONT, self.gameTitle, self.gameTitleFontSize, Colors.YELLOW1,
                            (Settings.SCREEN[0] // 2, (Settings.SCREEN[1] // 2) - 120)))
        labels.append(Label(Settings.MAIN_FONT, self.easy, self.modesFontSize, Colors.YELLOW1,
                            (Settings.SCREEN[0] // 2, (Settings.SCREEN[1] // 2) - 35)))
        labels.append(Label(Settings.MAIN_FONT, self.normal, self.modesFontSize, Colors.YELLOW1,
                            (Settings.SCREEN[0] // 2, (Settings.SCREEN[1] // 2) + 5)))
        labels.append(Label(Settings.MAIN_FONT, self.hard, self.modesFontSize, Colors.YELLOW1,
                            (Settings.SCREEN[0] // 2, (Settings.SCREEN[1] // 2) + 45)))
        labels.append(Label(Settings.SECONDARY_FONT, self.about, self.aboutFontSize, Colors.WHITE,
                            (Settings.SCREEN[0] // 2, Settings.SCREEN[1] - 75)))
        labels.append(Label(Settings.SECONDARY_FONT, self.images, self.aboutFontSize, Colors.WHITE,
                            (Settings.SCREEN[0] // 2, Settings.SCREEN[1] - 55)))
        labels.append(Label(Settings.SECONDARY_FONT, self.fonts, self.aboutFontSize, Colors.WHITE,
